		...
		[]prompbmarshal.MetricMetadata{
			{
				...
				Help:             "I'm a gauge",
				Type:             uint32(prompb.MetricMetadata_GAUGE),
				Unit:             "",
			},
			{
				MetricFamilyName: "my-histogram",
				Help:             "I'm a Histogram",
				Type:             uint32(prompb.MetricMetadata_HISTOGRAM),
				Unit:             "",
			},
			{
			...
			},
			{
				...
				Help:             "I might be a counter",
				Type:             uint32(prompb.MetricMetadata_COUNTER),
				Unit:             "",
			},
			{
				MetricFamilyName: "my-summary",
				Help:             "I'm a Summary",
				Type:             uint32(prompb.MetricMetadata_SUMMARY),
				Unit:             "",
			},
		},
		false,
...
func generateSum(name, unit string, isMonotonic bool) *pb.Metric {
	...
	return &pb.Metric{
		Name:        name,
		Unit:        unit,
		Description: "I might be a counter",
		Sum: &pb.Sum{
			AggregationTemporality: pb.AggregationTemporalityCumulative,
			DataPoints:             points,
